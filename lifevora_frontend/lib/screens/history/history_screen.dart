    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, i) {
          ...
          final isSelected = ap.filterType == filter;
          return Padding(
            padding: const EdgeInsets.only(right: 8),
            child: GestureDetector(
              onTap: () => ap.setFilter(filter),
  ...
  Future<void> _deleteActivity(BuildContext context, String id) async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content:
            const Text('Voulez-vous supprimer cette activité?'),
        actions: [
          TextButton(
    ...
    if (confirm == true && context.mounted) {
      await context.read<ActivityProvider>().deleteActivity(id, userId);
    }
  }
